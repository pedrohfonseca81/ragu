...
> Everything under this folder is an example. Delete it (or run `npx create-ragu --no-example`) and start from the [templates](https://github.com/pedrohfonseca/ragu/tree/main/template/templates).
